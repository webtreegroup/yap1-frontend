...
import { IChatMessageForm } from './ChatMessageForm.types'

export class ChatMessageForm extends Form<IChatMessageForm> {
    constructor(props?: IChatMessageForm) {
        ...
        const BtnSubmit = new Button({
            ...
            `,
            btnType: 'submit',
            className: ['btn_no-style', 'btn-send'],
        })
    ...
    onSubmit(request: IChatMessage): void {
        this.props.onMessageSend?.(request)
    }
}
